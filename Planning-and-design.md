...
According to Anthropic's [engineering blog](https://claude.com/blog/equipping-agents-for-the-real-world-with-agent-skills): "This metadata...provides just enough information for Claude to know when each skill should be used without loading all of it into context." This is the first level of progressive disclosure.
...
Keep SKILL.md focused on core instructions. Move detailed documentation to `references` and link to it. (See [Core Design Principles](https://claude.com/blog/equipping-agents-for-the-real-world-with-agent-skills) for how the three- level system works.)
