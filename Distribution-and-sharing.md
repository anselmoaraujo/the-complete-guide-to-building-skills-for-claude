...
* [Create Custom skills](https://platform.claude.com/docs/en/api/beta/skills/create)

* [Skills in the Agent SDK](https://platform.claude.com/docs/en/agent-sdk/skills)
